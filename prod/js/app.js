	...
	var Card = (function (_React$Component) {
	  ...
	  _createClass(Card, [{
	    ...
	    value: function addComment() {
	      ...
	      if (!$.trim(content)) {
	        return _jsModuleTipJs2['default'].showTip('评论内容不能为空', 2000, 'warn');
	      }
	      _jsModuleHttpJs2['default'].commentAddJokeComment(_self.jokeId, content).then(function (res) {
	        ...
	        _jsModuleTipJs2['default'].showTip('评论成功', 2000, 'success');
	        _self.$comment.val('');
	      });
	    }
	  }, {
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              ...
	              _react2['default'].createElement('input', { type: 'text', name: 'comment', placeholder: '我也说一句...' })
	            ),
	            _react2['default'].createElement(
	              'button',
	          ...
	          addJokeHtml = _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              ...
	              _react2['default'].createElement(
	                ...
	                _react2['default'].createElement('input', { type: 'text', placeholder: '标题', name: 'title' })
	              ),
	              _react2['default'].createElement(
	                'div',
	                ...
	                _react2['default'].createElement('textarea', { type: 'text', placeholder: '内容', name: 'content' })
	              ),
	              _react2['default'].createElement(
	                'div',
	...
	var SignIn = (function (_React$Component) {
	  ...
	  _createClass(SignIn, [{
	    ...
	    value: function userSignIn() {
	      ...
	      if (!email) {
	        return _jsModuleTipJs2['default'].showTip('邮箱不能为空', 2000, 'warn');
	      }
	      if (!password) {
	        return _jsModuleTipJs2['default'].showTip('密码不能为空', 2000, 'warn');
	      }
	      if (!_jsModuleRegularExpressionJs2['default'].emailRegExp.test(email)) {
	        return _jsModuleTipJs2['default'].showTip('邮箱格式错误，如：example@qq.com', 2000, 'warn');
	      }
	      _jsModuleHttpJs2['default'].userSignIn(email, password).then(function (res) {
	        if (res.error) {
	          switch (res.errorCode) {
	            case 1001:
	              _jsModuleTipJs2['default'].showTip('账号不存在', 2000, 'warn');
	              break;
	            case 1002:
	              _jsModuleTipJs2['default'].showTip('密码错误', 2000, 'warn');
	              break;
	          }
	          return console.log(res);
	        }
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement('input', { type: 'text', placeholder: '邮箱', name: 'email' })
	          ),
	          _react2['default'].createElement(
	            'div',
	            { className: 'ui-form-item ui-form-item-textarea ui-border-b' },
	            ...
	            _react2['default'].createElement('input', { type: 'password', placeholder: '密码', name: 'password' })
	          ),
	          _react2['default'].createElement(
	            'div',
	            { className: 'ui-btn-wrap' },
	...
	var SignUp = (function (_React$Component) {
	  ...
	  _createClass(SignUp, [{
	    ...
	    value: function signUp() {
	      ...
	      if (!username) {
	        return _jsModuleTipJs2['default'].showTip('用户名不能为空', 2000, 'warn');
	      }
	      if (!password) {
	        return _jsModuleTipJs2['default'].showTip('密码不能为空', 2000, 'warn');
	      }
	      if (password !== repeatPassword) {
	        return _jsModuleTipJs2['default'].showTip('两次密码不一致', 2000, 'warn');
	      }
	      _jsModuleHttpJs2['default'].userSignUp(email, password, username).then(function (res) {
	        if (res.error) {
	          switch (res.errorCode) {
	            case 1003:
	              _jsModuleTipJs2['default'].showTip('账号已存在', 2000, 'warn');
	              break;
	          }
	        }
	        console.log(res);
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement('input', { type: 'text', placeholder: '用户名', name: 'username' })
	          ),
	          _react2['default'].createElement(
	            'div',
	            { className: 'ui-form-item ui-form-item-textarea ui-border-b' },
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement('input', { type: 'password', placeholder: '重复密码', name: 'repeatPassword' })
	          ),
	          _react2['default'].createElement(
	            'div',
	            { className: 'ui-btn-wrap' },
